...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://raw.githubusercontent.com/SukyTD/basicBot/master/lang/langIndex.json", function (json) {
    ...
    var basicBot = {
        ...
        name: "Karl Bot",
        loggedInID: null,
        scriptLink: "https://raw.githubusercontent.com/SukyTD/mycustombasicbot3/master/extension.js",
        cmdLink: "https://goo.gl/oX3C3r",
        chatLink: "https://raw.githubusercontent.com/SukyTD/basicBot/master/lang/en.json",
        chat: null,
        loadChat: loadChat,
	    ...
	    thorCommand: true,
            ...
            ["wat","http://i.imgur.com/iPD7hEp.jpg"],
            ...
            ["noice", "http://i.imgur.com/fOEm86S.gif"],
            ...
            ["damn","http://static1.gamespot.com/uploads/original/1540/15406759/2765401-5811396321-tumbl.gif"],
            ["hi","https://s-media-cache-ak0.pinimg.com/originals/0e/ce/80/0ece80cb70db661ade81157161d6ecff.gif"],
            ["hello","http://33.media.tumblr.com/tumblr_lpr0ohYgs51qjp0of.gif"],
            ...
            ["pizza2","https://media.giphy.com/media/11H2sYCtWyuTF6/giphy.gif"],
            ["party","http://i.imgur.com/n2yqxMy.gif"],
            ["brb","https://31.media.tumblr.com/ef1849b87dda8e2599e66fda54e8b05f/tumblr_mpqytgoX6Y1rd80hmo1_400.gif"],
            ["http://i.imgur.com/vn1qM3z.gif","http://i.imgur.com/vn1qM3z.gif"],
            ["turnup", "http://images.rapgenius.com/cbfc9814b81cfa58cfde6f4e5a4504ee.480x270x19.gif"],
	    ["housefire", "http://img3.wikia.nocookie.net/__cb20130528190013/creepypasta/images/0/05/House-on-fire-o.gif"],
            ...
            commandLiteral: "!",
            blacklists: {
                NSFW: "https://raw.githubusercontent.com/SukyTD/mycustombasicbot3/master/blacklists/NSFWlist.json",
                OP: "https://raw.githubusercontent.com/SukyTD/mycustombasicbot3/master/blacklists/OPlist.json",
                BANNED: "https://raw.githubusercontent.com/SukyTD/mycustombasicbot3/master/blacklists/BANNEDlist.json"
            }
        },
        room: {
            name: null,
 ...
 //                   API.sendChat('!joindisable');
            ...
            raffle: {
                ...
                endraffle: function () {
                    ...
                    API.sendChat(subChat(basicBot.chat.winnerpickedrf, {name: name, position: pos}));
                }
        },
            roulette: {
        ...
        eventDjadvance: function (obj) {
            ...
            if (basicBot.settings.autoskip) {
                ...
                basicBot.room.autoskipTimer = setTimeout(function() {
                    ...
                    if (startcid === endcid) {
                        API.sendChat('/me Song stuck, skipping...');
                        API.moderateForceSkip();
                    }
                }, remaining + 5000);
            }
  ...
  //          msg = msg.replace(/[ ,;.:\/=~+%^*\-\\"'&@#]/g, '');
    ...
    /*        var ch;
        ...
        startup: function () {
            ...
            basicBot.connectAPI();
            $.getScript('https://raw.githubusercontent.com/SukyTD/basicBot/master/countdown.js');
           /* setTimeout(function () {
	    	sendToSocket();
                storeToStorage();
        ...
        commands: {
            ...
            loveCommand: {
                ...
                getlove: function (chat) {
                    var c = Math.floor(Math.random() * basicBot.chat.loves.length);
                    return basicBot.chat.loves[c];
                },
                functionality: function (chat, cmd) {
                    if (this.type === 'exact' && chat.message.length !== cmd.length) return void (0);
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
